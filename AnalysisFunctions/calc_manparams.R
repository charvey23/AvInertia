...
range_q_model_mcmc_output_adj  = summary(range_q_model_mcmc_adj)
...
tmp1               = aggregate(list(min_sm_nd = dat_comp$min_sm_nd,
                                    min_q = dat_comp$min_q), by = list(species = dat_comp$species), min)
tmp2               = aggregate(list(max_sm_nd = dat_comp$max_sm_nd,
                                    max_q = dat_comp$max_q), by = list(species = dat_comp$species), max)
