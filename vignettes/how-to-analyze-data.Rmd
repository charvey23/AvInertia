...
dat_wing_out      = massprop_birdwing(dat_id_curr, dat_bird_curr, dat_bone_curr, dat_feat_curr, dat_mat, clean_pts, feather_inertia, plot_var = "xy")
```
...
## 4. If computing for asymmetric case, input a different set of clean pts
...
```{r combine_prop}
curr_full_bird      = combine_inertialprop(dat_torsotail_out,dat_wing_out,dat_wing_out, symmetric=TRUE)
```
